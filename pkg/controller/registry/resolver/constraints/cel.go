...
func NewCelEvaluatorProvider() EvaluatorProvider {
	env, err := cel.NewEnv(
		cel.Declarations(decls.NewVar("properties",
...
func (semverLib) CompileOptions() []cel.EnvOption {
	return []cel.EnvOption{
		cel.Declarations(decls.NewFunction("semver_compare",
			decls.NewOverload("semver_compare", []*expr.Type{decls.String, decls.String}, decls.Int),
		)),
	}
}
